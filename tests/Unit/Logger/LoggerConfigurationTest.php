...
test('デフォルトではRFC3339_EXTENDED形式を使用する', function (): void {
    $config = new LoggerConfiguration();
    expect($config->getDateFormat())->toBe(DateTimeInterface::RFC3339_EXTENDED);
});

test('カスタムの日付フォーマットを使用できる', function (): void {
